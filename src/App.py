...
import sqlite3
from datasetFaces import DatasetFaces
from trainerFaces import Trainer
from recognitionFaces import Recognition
...
class Start(tk.Frame):
    ...
    def __init__(self, master):
        ...
        tk.Button(self, text="Register Student",
                  font= ('Helvetica 18 bold'),relief='raised',
    ...
    def recognition(self):
        ...
        self.cursor.execute(f"SELECT * FROM Students WHERE id IN ('{','.join(str(student) for student in ids_students_in_class)}')")
        ...
        self.tree.pack()
        messagebox.showinfo("","The list of attendance has been dowloaded and it's on the Downloads Directory")
        workbook.close()
...
class Register(tk.Frame):
    ...
    def __init__(self,master):
        ...
        tk.Entry(self, justify="center", font='Times 16 italic',textvariable=self.name, bg="white").pack(pady=10)

        tk.Label(self, text="Last Name(s):", bg="#264653",fg="white",  font=font_example).pack(pady=10)
        tk.Entry(self, justify="center", font='Times 16 italic',textvariable=self.last_name, bg="white").pack(pady=10)

        tk.Button(self, text="Add Student", bg="#faedcd",command= self.add_student, font= 'Times 16 italic', cursor="hand2").pack(pady=20)
